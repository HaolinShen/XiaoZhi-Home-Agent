...
class AgentState(TypedDict):
    ...
    rag_status: NotRequired[Literal["answered", "refused"]]
    rag_citations: NotRequired[list[str]]
    rag_trajectory: NotRequired[list[dict[str, Any]]]
    rag_device_model: NotRequired[str | None]
